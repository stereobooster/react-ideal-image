...
export interface UnfetchOptionsInterface {
  method?: string;
  headers?: Record<string, any>;
  credentials?: string;
  body?: any;
}
export const unfetchOptions: UnfetchOptionsInterface = {
  method: "get",
  headers: {},
};
...
export const unfetch = (url: string, opts: UnfetchOptionsInterface = {}) => {
